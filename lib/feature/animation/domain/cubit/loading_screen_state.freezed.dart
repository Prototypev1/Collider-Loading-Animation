...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoadingScreenState);
}
...
$LoadingScreenStateCopyWith(LoadingScreenState _, $Res Function(LoadingScreenState) __);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoadingScreenStateInitial);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoadingScreenStateLoading);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoadingScreenStateSuccessfulCollision);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoadingScreenStateFlashSpread);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoadingScreenStateSuccess);
}
...
$LoadingScreenStateErrorCopyWith<LoadingScreenStateError> get copyWith => _$LoadingScreenStateErrorCopyWithImpl<LoadingScreenStateError>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LoadingScreenStateError&&(identical(other.message, message) || other.message == message));
}
...
/// @nodoc
abstract mixin class $LoadingScreenStateErrorCopyWith<$Res> implements $LoadingScreenStateCopyWith<$Res> {
  factory $LoadingScreenStateErrorCopyWith(LoadingScreenStateError value, $Res Function(LoadingScreenStateError) _then) = _$LoadingScreenStateErrorCopyWithImpl;
@useResult
$Res call({
 String message
});
