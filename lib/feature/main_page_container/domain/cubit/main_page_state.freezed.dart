...
mixin _$MainPageState {
  ...
  $MainPageStateCopyWith<MainPageState> get copyWith =>
      _$MainPageStateCopyWithImpl<MainPageState>(
          this as MainPageState, _$identity);
...
abstract mixin class $MainPageStateCopyWith<$Res> {
  factory $MainPageStateCopyWith(
          MainPageState value, $Res Function(MainPageState) _then) =
      _$MainPageStateCopyWithImpl;
  @useResult
  $Res call({int page});
}
...
class MainPageStateInitial implements MainPageState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $MainPageStateInitialCopyWith<MainPageStateInitial> get copyWith =>
      _$MainPageStateInitialCopyWithImpl<MainPageStateInitial>(
          this, _$identity);
...
/// @nodoc
abstract mixin class $MainPageStateInitialCopyWith<$Res>
    implements $MainPageStateCopyWith<$Res> {
  factory $MainPageStateInitialCopyWith(MainPageStateInitial value,
          $Res Function(MainPageStateInitial) _then) =
      _$MainPageStateInitialCopyWithImpl;
  @override
  @useResult
  $Res call({int page});
}
...
class MainPageStateLoading implements MainPageState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $MainPageStateLoadingCopyWith<MainPageStateLoading> get copyWith =>
      _$MainPageStateLoadingCopyWithImpl<MainPageStateLoading>(
          this, _$identity);
...
/// @nodoc
abstract mixin class $MainPageStateLoadingCopyWith<$Res>
    implements $MainPageStateCopyWith<$Res> {
  factory $MainPageStateLoadingCopyWith(MainPageStateLoading value,
          $Res Function(MainPageStateLoading) _then) =
      _$MainPageStateLoadingCopyWithImpl;
  @override
  @useResult
  $Res call({int page});
}
...
class MainPageStateSuccess implements MainPageState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $MainPageStateSuccessCopyWith<MainPageStateSuccess> get copyWith =>
      _$MainPageStateSuccessCopyWithImpl<MainPageStateSuccess>(
          this, _$identity);
...
/// @nodoc
abstract mixin class $MainPageStateSuccessCopyWith<$Res>
    implements $MainPageStateCopyWith<$Res> {
  factory $MainPageStateSuccessCopyWith(MainPageStateSuccess value,
          $Res Function(MainPageStateSuccess) _then) =
      _$MainPageStateSuccessCopyWithImpl;
  @override
  @useResult
  $Res call({int page});
}
...
class MainPageStateError implements MainPageState {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $MainPageStateErrorCopyWith<MainPageStateError> get copyWith =>
      _$MainPageStateErrorCopyWithImpl<MainPageStateError>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is MainPageStateError &&
...
/// @nodoc
abstract mixin class $MainPageStateErrorCopyWith<$Res>
    implements $MainPageStateCopyWith<$Res> {
  factory $MainPageStateErrorCopyWith(
          MainPageStateError value, $Res Function(MainPageStateError) _then) =
      _$MainPageStateErrorCopyWithImpl;
  @override
  @useResult
